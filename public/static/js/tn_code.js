...
var tncode = {
    ...
    _send_result: function () {
        ...
        var re = new _ajax();
        re.request('get', 'index/tools/check?tn_r=' + tncode._mark_offset, haddle);
    },
    ...
    refresh: function () {
        ...
        var img_url = "index/tools/tnCode?t=" + Math.random();
